...
public class Ability
{
    ...
    // Internal Vars
    public Character selfCharacter { get; private set; }
    ...
    public void OnProjectileHit(Character target)
    {
        Debug.Log("On hit");
        ...
        if (EventRegister[EventAbility.OnProjectileHitUnit] != null)
        {
            ...
            {
                selfCharacter.StartCoroutine(action.Excecute(this, indicator, selfCharacter, target));
            }
        }
    }
